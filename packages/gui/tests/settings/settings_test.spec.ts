...
test('Confirm user can navigate and interact the Settings page in user acceptable manner. ', async () => {
  ...
  // assert.equal(page.url(), 'file:///Users/jahifaw/Documents/Code/Chia-testnet-playwright/floteo-blockchain/floteo-blockchain-gui/packages/gui/build/renderer/index.html#/dashboard/settings');
